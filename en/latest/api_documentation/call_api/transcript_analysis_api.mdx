...
description: "Retrieve AI-analyzed call transcript data, including Signal AI classifications, keyword matches, and conversation insights, from the Invoca platform."
---
