...
| `advertiser_campaign_id_from_network` | The ID from network field on the advertiser campaign. The submitted call will be added to this campaign. **This campaign must be of type ExternalOnly.** See [Advertiser Campaigns](/en/latest/api_documentation/network_integration/advertiser_campaigns/index) for more details. |
