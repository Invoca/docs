...
description: "Submit external calls to the Invoca platform with optional recording upload so they can be tracked, attributed, and reported alongside Invoca-routed calls."
---
