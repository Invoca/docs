...
description: "Query and interact with live in-progress calls using Invoca PreSense to surface caller context, control routing, and send real-time data to call centers."
---
