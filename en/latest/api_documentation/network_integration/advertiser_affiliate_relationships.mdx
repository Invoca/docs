...
description: "Approve, list, and remove the relationships that connect advertisers with the affiliates promoting their campaigns using the Invoca Network Integration API."
---
