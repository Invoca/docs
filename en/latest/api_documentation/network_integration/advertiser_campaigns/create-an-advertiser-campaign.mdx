---
title: "Create an Advertiser Campaign"
description: "POST a new advertiser campaign to Invoca, setting name, campaign type, payouts, budgets, and terms via the Network Integration advertiser_campaigns endpoint."
api: POST https://invoca.net/api/2022-08-01/<network_id>/advertisers/cFUyYnFHyiYA42TrpM/advertiser_campaigns.json
