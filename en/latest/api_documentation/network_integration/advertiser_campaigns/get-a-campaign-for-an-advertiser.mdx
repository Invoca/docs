---
title: "Get a campaign for an Advertiser"
description: "GET a single advertiser campaign from Invoca, returning current and future terms, payouts, budgets, and status via the Network Integration API."
api: GET https://invoca.net/api/2022-08-01/<network_id>/advertisers/2/advertiser_campaigns/100.json
