...
description: "GET every advertiser (merchant) user attached to a specific advertiser on your Invoca network via the Network Integration API for audits and syncs."
