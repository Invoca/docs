...
description: "Manage the campaigns that affiliates (publishers) are promoting on your Invoca network, including opt-ins, payouts, and status, via the Network Integration API."
---
