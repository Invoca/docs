---
title: "Affiliates"
description: "Create, read, update, and delete affiliate (publisher) records on your Invoca network, including contact and payout settings, via the Network Integration API."
---
