...
description: "Enable and configure automated speech recognition (ASR) on Invoca campaigns to transcribe recorded calls for signals, via the Network Integration API."
---
