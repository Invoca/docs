...
description: "Define conditional logic that controls when Invoca records inbound calls on a campaign, using the Network Integration call_recording_condition endpoint."
---
