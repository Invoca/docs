...
description: "Configure the audio prompts Invoca plays to callers during IVR challenges on a campaign, using the Network Integration custom_challenge_prompts endpoint."
---
