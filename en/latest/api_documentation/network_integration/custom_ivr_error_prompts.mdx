---
title: "Custom IVR Error Prompts"
description: "Set the audio prompts Invoca plays when the IVR encounters an invalid key press or timeout, using the Network Integration custom_ivr_error_prompts endpoint."
---
