...
Destinations are an alternate way of managing [RingPools](/en/latest/api_documentation/network_integration/ringpools/index).
...
Creating a Destination via this endpoint isn't possible. A Destination can be made alongside a RingPool that it'll be associated with via the RingPool endpoint ([Documentation](/en/latest/api_documentation/network_integration/ringpools/index)).
