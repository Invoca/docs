...
description: "Upload, list, and delete the audio recordings that Invoca plays as IVR prompts on advertiser campaigns, using the Network Integration prompt_recordings API."
---
