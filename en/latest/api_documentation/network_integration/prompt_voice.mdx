---
title: "Prompt Voice"
description: "Choose the text-to-speech voice, language, and gender used for Invoca IVR prompts on advertiser campaigns, via the Network Integration prompt_voice endpoint."
---
