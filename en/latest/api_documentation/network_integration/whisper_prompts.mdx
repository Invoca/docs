...
description: "Configure the whisper messages Invoca plays to the receiving agent before a caller is connected on an advertiser campaign, via the Network Integration API."
---
