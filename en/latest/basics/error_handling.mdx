---
title: "Error handling for the Invoca APIs"
description: "Understand the JSON error responses returned by the Invoca APIs, including 404 not found, 403 validation failures, and 500 service errors with unique handles."
---
