...
the same logic [Destructive confirmation's own perform-then-undo rule](/invoca-design-system/patterns/destructive-confirmation#constraints)
...
| Uncertain | If the system isn't confident enough to commit outright, it doesn't act at this tier — it downgrades to a Draft-style suggestion instead. |
