...
| [**TITAN-DIV-37**](/invoca-design-system/foundations/divergences#titan-div-37) | Divergence | The footer and the content area use two unrelated horizontal insets |
...
- **Whether every real confirm action uses a non-default `confirmButtonColor` for destructive
  ...
  enforces [Dialog's own recommendation](/invoca-design-system/components/containment/dialog#constraints) beyond the constraint itself.
