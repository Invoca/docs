...
[the divergence on Button's naming](/invoca-design-system/foundations/divergences#titan-div-11) describes Button's
...
Package `@invoca/titan-core`, version **3.7.1**. Single export: `Badge`. No deprecation marker,
