...
- **No rule for the action's prominence.** [EmptyState's own constraints](/invoca-design-system/components/data-display/empty-state#constraints) require
  one action and do not say whether it is primary or secondary.
