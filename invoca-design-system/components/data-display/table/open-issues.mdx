...
| ID | Kind | What |
|---|---|---|
| [**TITAN-DIV-10**](/invoca-design-system/foundations/divergences#titan-div-10) | Divergence | This documentation's "table" is code's `DataGridPremium` and the design library's "Data Grid" |
...
`cellSelection`. Verified against the installed package, not inferred; until the story is
corrected, treat the props table it publishes as unreliable. No product adoption is recorded
for the grid export in the utilization data, so the adoption figures below cannot yet
corroborate any usage guidance on this page.
