...
<Warning>
  **The package exports this as `Chip`, not `Tag`.** This page's name is the design vocabulary's
  ...
  [Table](/invoca-design-system/components/data-display/table)/`DataGridPremium` — and `Chip` is the
  import. See the [naming divergence](/invoca-design-system/foundations/divergences#titan-div-10).
</Warning>
...
This is the same kind of alias as Table/`DataGridPremium` — the docs use the reader-facing word, and
...
Package `@invoca/titan-core`, version **3.7.1**. Single export: `Chip`. No deprecation marker or
