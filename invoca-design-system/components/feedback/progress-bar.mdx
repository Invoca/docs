...
<Warning>
  **The package exports this as `LinearProgress`, not `ProgressBar`.** This page's name is the
  ...
  pattern the [naming divergence](/invoca-design-system/foundations/divergences#titan-div-10) records for
...
| The process never completes | An indeterminate bar animates forever; a determinate one sits at whatever value it was last given | Same failure mode as an unresolved Skeleton — see [Skeleton's own constraints](/invoca-design-system/components/feedback/skeleton#constraints). Time out and show an [Alert](/invoca-design-system/components/feedback/alert). |
