...
| ID | Kind | What |
|---|---|---|
| Proposed addition to [**TITAN-DIV-10**](/invoca-design-system/foundations/divergences#titan-div-10) | Divergence | The package's export for ProgressBar is `LinearProgress` — not yet listed among that entry's worked examples (Table/`DataGrid`, Switch/`Toggle`, and others), though it is the same pattern. |
