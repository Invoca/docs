...
no decision is recorded — see the [open decision on skeleton tokens and animation](/invoca-design-system/foundations/open-decisions#titan-gap-31). Until one is
...
[radius](/invoca-design-system/foundations/radius) scale. That is the substance of the
[same open decision](/invoca-design-system/foundations/open-decisions#titan-gap-31), and it means a skeleton is currently the
...
until the component handles it.
