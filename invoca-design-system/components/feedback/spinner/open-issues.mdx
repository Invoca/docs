...
- **Whether `CircularProgress` is intentionally the low-adoption, narrowly-scoped choice — or
  ...
  undecided.** This page documents `CircularProgress` because that is the mapping the
  [naming divergence above](#known-issues) already records, but the adoption data raises a real question about whether that
