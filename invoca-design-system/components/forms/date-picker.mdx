...
<Note>
  Story ID `verified` against the real Chromatic Storybook index. Titan's DatePicker
  group has no `default` story — this is `basic-date-range-picker`, the first and
  simplest real story, matching this page's range-picker scope.
</Note>
