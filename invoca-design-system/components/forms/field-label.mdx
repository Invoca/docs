---
title: "FieldLabel"
description: "The labeling concept every form field renders — label text, required marker, helper text, and error text. Rendered by FormInput, not composed by hand."
icon: "type"
tag: "Stable"
...
**This is a concept page, not a component you reach for.** Every field label, helper text,
and error text on a form is rendered by [FormInput](/invoca-design-system/components/forms/form-input) — see
[TITAN-FORM-01](/invoca-design-system/components/forms/form#constraints). This page exists to define the vocabulary,
tokens, and accessibility contract those labels follow.

<Warning>
  **Do not import or render `FieldLabel` directly to attach a label to a field.** The label
  belongs to [FormInput](/invoca-design-system/components/forms/form-input), which composes it with the control and the
  helper-or-error slot as one field. A hand-attached `FieldLabel` skips that composition.
</Warning>
...
Never, directly. If you are attaching a label, helper text, or error text to a field, use
[FormInput](/invoca-design-system/components/forms/form-input) and let it render the FieldLabel for you. This page is here
to define what that label is and how it behaves — the vocabulary, the tokens, the
accessibility contract — not as something to reach for on its own.

## Choose something else when

| If you need to… | Use | Why |
|---|---|---|
| Add a labeled field | [FormInput](/invoca-design-system/components/forms/form-input) | FormInput composes the control with its label, helper, and error text as one field — see [TITAN-FORM-01](/invoca-design-system/components/forms/form#constraints). |
...
- [FormInput](/invoca-design-system/components/forms/form-input) — the component that renders this label; do not attach a FieldLabel to a field by hand
- [Input](/invoca-design-system/components/forms/input) · [Select](/invoca-design-system/components/forms/select) · [Checkbox](/invoca-design-system/components/forms/checkbox) — every field-style and control-style component receives its label this way
