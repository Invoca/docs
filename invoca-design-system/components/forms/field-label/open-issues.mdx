...
- **Two independent disabled-opacity values exist across the Forms group** — see the
  [open decision on disabled-opacity values](/invoca-design-system/foundations/open-decisions#titan-gap-32).
