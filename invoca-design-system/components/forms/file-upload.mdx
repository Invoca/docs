...
<Warning>
  **The package exports this as `Dropzone`, not `FileUpload`.** This page's name is the design
  vocabulary's term for the concept; `Dropzone` is the import. See the
  [naming divergence](/invoca-design-system/foundations/divergences#titan-div-26).
</Warning>
...
is why this page's own constraint exists as a rule rather than a suggestion.
