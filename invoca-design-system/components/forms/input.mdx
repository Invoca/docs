...
<Note>
  Story ID `verified` against the real Chromatic Storybook index. There is no
  top-level `Input` group — the free-text field this page describes is Titan's
  **Form Elements/TextField**, which does ship a `default` story.
</Note>
