...
<Note>
  Story ID `verified` against the real Chromatic Storybook index. Titan's own
  Storybook groups this component as **Toggle**, not `Switch`, and has no `default`
  story — this is `basic-toggles`.
</Note>
