...
<Note>
  **This gap is recorded** [in the central divergence register](/invoca-design-system/foundations/divergences#titan-div-32):
  code ships a bare, one-override `AppBar`; design's page template
