...
|---|---|---|
| **Button labels** | Title case | zeroheight's Button page, directly — see [Button's own constraint](/invoca-design-system/components/actions/button#constraints) on this |
...
<Note>
  **None of these is scoped to product UI copy specifically.** Where a term's everyday name
  ...
  `DataGrid`, see [the naming divergence](/invoca-design-system/foundations/divergences#titan-div-10) — the reader-facing
