...
|---|---|---|---|
| Performs an action | **Verb-first imperative phrase** | "Save Changes," "Delete Campaign" | [Button](/invoca-design-system/components/actions/button#constraints) |
...
| Use the reader's word for the thing, never the underlying library's internal name | [the naming divergence](/invoca-design-system/foundations/divergences#titan-div-10) |
| No terminal punctuation on any label | [Capitalization and punctuation](/invoca-design-system/content/capitalization-and-punctuation#constraints) |
...
| Plain language over jargon or internal acronyms | [Voice and tone](/invoca-design-system/content/voice-and-tone#constraints) |
...
| **TITAN-UILABEL-03** | A label uses the reader's word for the thing it names, never the underlying library's or framework's internal name. | [The naming divergence](/invoca-design-system/foundations/divergences#titan-div-10) — "Table," not `DataGrid`. |
