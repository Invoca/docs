...
| [`TITAN-TBL-06`](/invoca-design-system/components/data-display/table#constraints) | Cells truncate; column headers do not | `DataGridPremium`'s shipped themed default, not a per-table choice |
...
it is simply frozen. See [the divergence this is recorded as](/invoca-design-system/foundations/divergences#titan-div-05).
...
This is why [the open decision on token duplication](/invoca-design-system/foundations/open-decisions#titan-gap-04) — seven groups of tokens
