...
- **No process is documented for proposing a new icon**, though the main page's own constraint
  requires one.
...
- **No icon-to-meaning registry exists.** The main page's own constraint requires one glyph
