...
design decision yet, and this documentation does not define them.
...
<Warning>
  **The specification and the shipped tokens have diverged substantially** — 215 specified
  ...
  [token reference](/invoca-design-system/foundations/color#token-reference) to know what actually exists.
</Warning>
