...
<Note>
  **"Modal" is this page's word for what Titan's design language calls Dialog** — and what the
  package itself exports as `Modal`, per [TITAN-DIALOG-01](/invoca-design-system/components/containment/dialog#constraints).
  All three names point at the same thing. This page uses "Modal" because that's the term this
  request used and the one most readers reach for; every link below goes to the real Dialog
  page.
</Note>
