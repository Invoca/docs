...
real view.** [TITAN-FSEARCH-05](#constraints) isn't a convenience — a filtered list a reader
can't bookmark, share, or return to via the back button is functionally invisible to everything
outside the single session that created it.
