...
team needs the same thing — see [TITAN-GAP-31](/invoca-design-system/foundations/open-decisions#titan-gap-31)'s
already-measured cost of exactly that pattern.
