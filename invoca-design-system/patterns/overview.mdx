...
<Columns cols={2}>
  ...
  <Card title="Footers" icon="panel-bottom" href="/invoca-design-system/patterns/footers">
    One fixed footer per view, holding the whole view's commit — not one per section.
  </Card>
...
| Footers | **Decided** for the configuration-view case; **Proposal** for the container-scoped case |
