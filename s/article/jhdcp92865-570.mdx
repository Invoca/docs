---
title: "Set up SAML SSO for Invoca"
description: "Configure SAML single sign-on with identity providers such as Microsoft ADFS, Okta, or Azure so your users can log in to Invoca without a separate password."
---
