---
title: "SIP integration overview for Invoca calls"
description: "Learn how the Invoca SIP integration routes inbound calls over the internet to reduce telecom fees and deliver PreSense real-time data to call center agents."
---
